...
namespace Chromely.CefSharp.Win.Controllers
{
    ...
    public class WebsocketDemoController : ChromelyController
    {
        ...
        public WebsocketDemoController()
        {
            ...
            this.mServerSentMessages.Add("https://github.com/chromelyapps/Chromely");
            ...
            this.mServerSentMessages.Add("For more info see - https://github.com/chromelyapps/Chromely/wiki/Real-time-with-Websocket");
